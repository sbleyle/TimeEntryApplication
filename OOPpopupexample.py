...
def popupmsg():
    ...
    select_button = Button(screen, text = "Select", command = popupmsgcommands())
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        engagementcode_client1_search = Button(wrapper1frame)
        ...
        notes_client1_notes = Button(wrapper1frame)
        ...
        engagementcode_client1_search = Button(wrapper2frame)
        engagementcode_client1_search.grid(column = 1, row = 3, sticky = "we", padx = 5, pady = 5)
        ...
        notes_client1_notes = Button(wrapper2frame)
        notes_client1_notes.grid(column = 10, row = 3, sticky = "we", padx = 5, pady = 5)
