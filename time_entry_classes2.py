...
class Win1:
    ...
    def show_widgets(self):
        ...
        self.engagementcode_client1_search = Button(self.wrapper1frame, image = self.search_icon_resize, command = self.create_button)
    ...
    def create_button(self, image, _class):
        ...
        tk.Button(
            ...
            command=lambda: self.new_window(_class))
